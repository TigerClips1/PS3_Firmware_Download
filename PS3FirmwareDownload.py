...
def menu_2():
    #print the menu option on screen in this function
    while True:
        print("[19] PS3_Firmware_455")
        print("[20] PS3_Firmware_453")
        print("[21] PS3_Firmware_450")
        print("[22] PS3_Firmware_446")
        print("[23] PS3_Firmware_445")
        print("[24] PS3_Firmware_441")
        print("[25] PS3_Firmware_440")
        print("[26] PS3_Firmware_431")
        print("[27] PS3_Firmware_430")
        print("[28] PS3_Firmware_425")
        print("[29] PS3_Firmware_421")
        print("[30] PS3_Firmware_420")
        print("[31] PS3_Firmware_411")
        print("[32] PS3_Firmware_410")
        print("[33] PS3_Firmware_400")
        print("[34] PS3_Firmware_374")
        print("[35] Next page 2/6")
        print("[36] Back")
        option = input("Enter the PS3 firmware you want to install: ") #get input from user
        #this will make the menu execute these variables from the class in PS3Firmwares.py
        if option == "19":
...
def menu_3():
    #print the menu option on screen in this function
    while True:
        print("[37] PS3_Firmware_373")
        print("[38] PS3_Firmware_372")
        print("[39] PS3_Firmware_370")
        print("[40] PS3_Firmware_366")
        print("[41] PS3_Firmware_365")
        print("[42] PS3_Firmware_361")
        print("[43] PS3_Firmware_360")
        print("[44] PS3_Firmware_356_v2")
        print("[45] PS3_Firmware_356_v1")
        print("[46] PS3_Firmware_355")
        print("[47] PS3_Firmware_350")
        print("[48] PS3_Firmware_342")
        print("[49] PS3_Firmware_341_v2")
        print("[50] PS3_Firmware_341_v1")
        print("[51] PS3_Firmware_340")
        print("[52] PS3_Firmware_321")
        print("[53] Next page 3/6")
        print("[54] Back")
        option = input("Enter the PS3 firmware you want to install: ") #get input from user
        #this will make the menu execute these variables from the class in PS3Firmwares.py
        if option == "37":
...
def menu_4():
    #print the menu option on screen in this function
    while True:
        print("[55] PS3_Firmware_316")
        print("[56] PS3_Firmware_315")
        print("[57] PS3_Firmware_310")
        print("[58] PS3_Firmware_301")
        print("[59] PS3_Firmware_300")
        print("[60] PS3_Firmware_280")
        print("[61] PS3_Firmware_276")
        print("[62] PS3_Firmware_270")
        print("[63] PS3_Firmware_260")
        print("[64] PS3_Firmware_253")
        print("[65] PS3_Firmware_252")
        print("[66] PS3_Firmware_250")
        print("[67] PS3_Firmware_243")
        print("[68] PS3_Firmware_242")
        print("[69] PS3_Firmware_241")
        print("[70] PS3_Firmware_240")
        print("[71] Next page 4/6")
        print("[72] Back")
        option = input("Enter the PS3 firmware you want to install: ") #get input from user
        #this will make the menu execute these variables from the class in PS3Firmwares.py
        if option == "55":
...
def menu_5():
    while True:
        #print the menu option on screen in this function
        print("[73] PS3_Firmware_236")
        print("[74] PS3_Firmware_235")
        print("[75] PS3_Firmware_230")
        print("[76] PS3_Firmware_220")
        print("[77] PS3_Firmware_217")
        print("[78] PS3_Firmware_216")
        print("[79] PS3_Firmware_210")
        print("[80] PS3_Firmware_201")
        print("[81] PS3_Firmware_200")
        print("[82] PS3_Firmware_194")
        print("[83] PS3_Firmware_193")
        print("[84] PS3_Firmware_192")
        print("[85] PS3_Firmware_190")
        print("[86] PS3_Firmware_182")
        print("[87] PS3_Firmware_181")
        print("[88] PS3_Firmware_180")
        print("[89] Next page 5/6")
        print("[90] Back")
        option = input("Enter the PS3 firmware you want to install: ") #get input from user
        #this will make the menu execute these variables from the class in PS3Firmwares.py
        if option == "73":
...
def menu_6():
    #print the menu option on screen in this function
    while True:
        print("[91] PS3_Firmware_170")
        print("[92] PS3_Firmware_160")
        print("[93] PS3_Firmware_154")
        print("[94] PS3_Firmware_151")
        print("[95] PS3_Firmware_150")
        print("[96] PS3_Firmware_132")
        print("[97] PS3_Firmware_130")
        print("[98] PS3_Firmware_111")
        print("[99] PS3_Firmware_110")
        print("[100 PS3_Firmware_102")
        print("[101] Back")
        option = input("Enter the PS3 firmware you want to install: ") #get input from user
        #this will make the menu execute these variables from the class in PS3Firmwares.py
        if option == "91":
